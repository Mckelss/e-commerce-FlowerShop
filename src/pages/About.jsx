      ...
      <section className="about-section">
        <div className="about-container" >
          ...
          <div className="about-img">
            <img src="/public/assets/flowers/f.jpg" />
          </div>
          <div className="about-img">
            <img src="/public/assets/flowers/d.jpg" />
          </div>
          <div className="about-img">
            <img src="/public/assets/flowers/c.jpg" />
          </div>
          <div className="about-img">
            <img src="/public/assets/flowers/bg.jpg" />
          </div>
          <div className="about-img">
            <img src="/public/assets/flowers/b.jpg" />
          </div>
        </div>
      </section>
    </div>
